...
variable "ingress_certificate_letsencrypt_staging_name" {
  default = "tls-secret-staging"
}
variable "ingress_certificate_letsencrypt_prod_name" {
  default = "tls-secret-staging"
}
variable "ingress_certificate_letsencrypt_name" {
  default = "tls-secret-staging"
}
